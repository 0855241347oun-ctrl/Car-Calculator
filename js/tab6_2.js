document.addEventListener('DOMContentLoaded', () => {
    const tankSelect = document.getElementById('tab6-2-tank-select');
    const tankCustom = document.getElementById('tab6-2-tank-custom');
    const pctInput = document.getElementById('tab6-2-pct');
    const resultLiter = document.getElementById('tab6-2-liter-result');
    const clearBtn = document.getElementById('clear-tab6-2-btn');
    ...
    // Copy result button
    const copyBtn = document.getElementById('copy-tab6-2-btn');
    const copyIcon = document.getElementById('copy-tab6-2-icon');
    const copyCheck = document.getElementById('copy-tab6-2-check');
