document.addEventListener('DOMContentLoaded', () => {
    const tankSelect = document.getElementById('tab5-tank-select');
    const tankCustom = document.getElementById('tab5-tank-custom');
    const litersInput = document.getElementById('tab5-liters');
    const resultPct = document.getElementById('tab5-pct-result');
    const clearBtn = document.getElementById('clear-tab5-btn');
    ...
    // Copy result button
    const copyBtn = document.getElementById('copy-tab5-btn');
    const copyIcon = document.getElementById('copy-tab5-icon');
    const copyCheck = document.getElementById('copy-tab5-check');
